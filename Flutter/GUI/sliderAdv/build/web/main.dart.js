...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new slider.Slider.new({value: this.moodValue, min: 0, max: 4, divisions: 4, label: this.moodValue[$toString](), onChanged: dart.fn(value => {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC5C4B;AACxB,YAAO,iCACE,wBACA,2CACmB,oCACV,kBACS,kCAEd,2CACe,kCACV,kBACS,uEAGG;IAEhC;;;QApBmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAmCX;;;;;;;;;;;;AAGsB;IAAkB;;;QAd7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;UAqBxB;AAExB,YAAO,oCACG,+BACD,kBAAK,AAAO,4BAEb,6BACG,yCACgC,yCACnB,wBAEhB,8BACS,qBACF,QACA,cACM,UACJ,AAAU,wCACN,QAAQ;AAIf,kBAHF,cAAS;AACU,oBAAjB,iBAAY,KAAK;AACD,oBAAhB,WAAM;;;IAYtB;;;;;;IAnCO,iBAAU;;;EAoCnB;;;;;;;;;;;;;AAlFuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
